...
<div class="userRegister">
	...
	<form:form method="post" commandName="registerForm" action="${action}">
		<div class="form_field-elements js-recaptcha-captchaaddon">
			...
			<h4>Gender *</h4>  
			<form:radiobutton  labelKey="register.gender"  path="gender" value="Male" label="Male" /> 
            <form:radiobutton labelKey="register.gender"  path="gender" value="Female" label="Female" />
