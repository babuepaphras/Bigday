...
<div class="userLogin">
	...
	<form:form id="loginForm" action="/bigdaystorefront/electronics/en/login" method="POST" commandName="loginForm">
 ...
 <div class="form-actions clearfix">
			<ycommerce:testId code="login_Login_button">
				 <button type="submit" class="positive"><spring:theme code="${actionNameKey}"/> LOGIN</button> 
			<a href="<c:url value="register.tag"/>">Register</a>
			</ycommerce:testId>
