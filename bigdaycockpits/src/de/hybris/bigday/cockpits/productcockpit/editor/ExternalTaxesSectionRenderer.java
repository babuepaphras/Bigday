 ...
 *  
 */
package de.hybris.bigday.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("bigdaycockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("bigdaycockpits.product.externalTaxes"));
