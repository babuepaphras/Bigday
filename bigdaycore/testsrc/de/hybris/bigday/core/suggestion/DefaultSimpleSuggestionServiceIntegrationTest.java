 ...
 *  
 */
package de.hybris.bigday.core.suggestion;
...
import de.hybris.bigday.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/bigdaycore/test/testSimpleSuggestionService.csv", "utf-8");
	}
