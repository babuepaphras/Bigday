 ...
 *  
 */
package de.hybris.bigday.core.hmc;
...
/**
 * Provides necessary meta information about the bigdaycore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class BigdayCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(BigdayCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.bigday.core.hmc.locales";
