 ...
 *  
 */
package de.hybris.bigday.fulfilmentprocess.test.jobs;
...
import de.hybris.bigday.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = BigdayFulfilmentProcessConstants.ORDER_PROCESS_NAME;
