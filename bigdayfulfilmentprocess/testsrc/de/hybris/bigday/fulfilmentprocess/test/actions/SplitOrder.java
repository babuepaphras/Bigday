 ...
 *  
 */
package de.hybris.bigday.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BigdayFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BigdayFulfilmentProcessConstants.PARENT_PROCESS);
