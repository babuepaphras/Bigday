 ...
 *  
 */
package de.hybris.bigday.test.setup;
...
import de.hybris.bigday.test.constants.BigdayTestConstants;
import de.hybris.bigday.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BigdayTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/bigdaytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/bigdaytest/import/reviews.impex");
			...
			importImpexFile(context, "/bigdaytest/import/cstickets.impex");
		}
	}
}
